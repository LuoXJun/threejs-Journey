import meshline_frag from './shaders/THREE.MeshLine_frag.glsl?raw'
import meshline_vert from './shaders/THREE.MeshLine_vert.glsl?raw'

export const mm = function () {
  "use strict";
  var root = this;
  ...
  THREE.ShaderChunk["meshline_vert"] = meshline_vert;

  THREE.ShaderChunk["meshline_frag"] = meshline_frag
    ...
    constructor(parameters) {
      super({
        uniforms: Object.assign({}, THREE.UniformsLib.fog, {
          ...
          ...parameters.customUniforms,
        }),

        vertexShader: parameters.vertexShader || meshline_vert,

        fragmentShader: parameters.fragmentShader || meshline_frag,
      });
